...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Shahriyor Sharifjonov - Fullstack developer</title>
        <link rel="canonical" href="https://www.shahriyorweb.com" />
      </Head>
      <div className={`${styles.wrapper} wrapper`}>
        <Header page="home"/>
        <motion.main className={`${styles.container} main`} initial="pageInitial" animate="pageAnimate" variants={{
          pageInitial: {
            opacity: 0
          },
          pageAnimate: {
          ...
          >
            ...
            <h1 className={styles.title}>Shahriyor<br />Sharifjonov</h1>
            <h2 className={styles.subtitle}>&gt; Full-stack developer</h2>
            <a href="https://www.linkedin.com/in/shahriyorweb/" className={styles.btn} target="_blank" rel="noreferrer">
              View Resume 
            </a>
          </motion.div>
          ...
          >
            ...
            <div className={styles.gameInfo}>
              ...
              <Link href="/about">
                <motion.a className={`btn ${styles.gameSkipBtn}`}
